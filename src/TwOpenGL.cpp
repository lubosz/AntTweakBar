...
int CTwGraphOpenGL::Init()
{
    ...
    // Get extensions
//    glBindBufferARB = reinterpret_cast<PFNGLBindBufferARB>(glGetProcAddress("glBindBufferARB"));
//    glBindProgramARB = reinterpret_cast<PFNGLBindProgramARB>(glGetProcAddress("glBindProgramARB"));
//    glGetHandleARB = reinterpret_cast<PFNGLGetHandleARB>(glGetProcAddress("glGetHandleARB"));
//    glUseProgramObjectARB = reinterpret_cast<PFNGLUseProgramObjectARB>(glGetProcAddress("glUseProgramObjectARB"));
//    glTexImage3D = reinterpret_cast<PFNGLTexImage3D>(glGetProcAddress("glTexImage3D"));
//    glActiveTextureARB = reinterpret_cast<PFNGLActiveTextureARB>(glGetProcAddress("glActiveTextureARB"));
//    glClientActiveTextureARB = reinterpret_cast<PFNGLClientActiveTextureARB>(glGetProcAddress("glClientActiveTextureARB"));
//    glBlendEquation = reinterpret_cast<PFNGLBlendEquation>(glGetProcAddress("glBlendEquation"));
//    glBlendEquationSeparate = reinterpret_cast<PFNGLBlendEquationSeparate>(glGetProcAddress("glBlendEquationSeparate"));
//    glBlendFuncSeparate = reinterpret_cast<PFNGLBlendFuncSeparate>(glGetProcAddress("glBlendFuncSeparate"));
